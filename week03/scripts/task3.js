...
function addNumbers() {
    let addend_1 = parseInt(document.querySelector("#addend1").value);
    let addend_2 = parseInt(document.querySelector("#addend2").value);
    let answer = add(addend_1, addend_2)
...
const subtractNumbers = function() {
    ...
    document.getElementById('difference').value = answer;
}
...
const multiplyNumbers = function() {
    let factor_1 = parseInt(document.getElementById('factor1').value);
    let factor_2 = parseInt(document.getElementById('factor2').value);
    let answer = multiply(factor_1, factor_2);
